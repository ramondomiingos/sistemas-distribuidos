...
def configure_otel(app):
    ...
    trace.set_tracer_provider(
        TracerProvider(
            resource=Resource.create({SERVICE_NAME: "payments-service"})
        )
    )
    ...
    # Nota: Não iniciamos start_http_server aqui para evitar conflito de porta
    # As métricas são expostas via middleware do FastAPI
